...
<body>
	...
	<div class="container mt-5">
		...
		<div th:if="${historiasClinicas != null and historiasClinicas.size() > 0}">
			<h2 class="mt-4">Historia Clínica de <span th:text="${pacientes[0].nombre}"></span>:</h2>
			<ul class="list-group mt-3">
				<li th:each="historia : ${historiasClinicas}" class="list-group-item">
					<div class="row">
						<div class="col-md-6">
							<strong>Fecha:</strong> <span th:text="${historia.fechaCita}"></span><br>
							<strong>Médico:</strong> <span th:text="${historia.doctorId}"></span><br>
							<strong>Síntomas:</strong> <span th:text="${historia.sintomas}"></span><br>
							<strong>Diagnóstico:</strong> <span th:text="${historia.diagnostico}"></span><br>
